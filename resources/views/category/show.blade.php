    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Category</li>
                <li class="active">Article category view</li>
            </ol>
        </section>
                              ...
                              <div class="table-responsive"> 
                                    <table class="table table-striped table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="15">Bengali:</td>
                                                <td>{{ $articleCategoryLang->title }}</td>
                                            </tr>
                                            <tr>
                                                <td>Keyword</td>
                                            ...
                                            <tr>
                                                <td>Bengali:</td>
                                                <td>{{ $articleCategoryLang->meta_keyword }} </td>
                                            </tr>
                                            <tr>
                                                <td>Description</td>
                                            ...
                                            <tr>
                                                <td>Bengali</td>
                                                <td>{{ $articleCategoryLang->meta_description }} </td>
                                            </tr>
                                            <tr>
                                                <td>Active</td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <table class="table">
                                                        <tr>
                                                             <td width="10">
                                                                {!! link_to_route('category.index', 'Back') !!}
                                                            </td>
                                                            <td>
