	            ...
	            <div class="col-md-12">
	                <div class="panel panel-primary">
	                	<div class="panel-heading">
	                		<h4 class="panel-title"> <img src="#" />Add new user</h4>
			                        	       ...
			                        	       <h1 class="title current" id="wizard-h-0" tabindex="-1">User
			                        	        ...
			                        	        <section aria-hidden="false" aria-labelledby="wizard-h-0" class="body current" id="wizard-p-0" role="tabpanel" style="display: block;">
			                        	            <div class="form-group">
			                        	                <label class="col-sm-2 control-label" for="firstname">First Name
			                        	                    *</label>
			                        	                <div class="col-sm-10">
			                        	                    <input aria-required="true" class="form-control required" id="firstname" name="firstname" placeholder="First Name" value="{{ old('firstname') }}" type="text" />
			                        	                </div>
			                        	            </div>
			                        	            <div class="form-group">
			                        	                ...
			                        	                <div class="col-sm-10">
			                        	                    <input aria-required="true" class="form-control required" id="middlename" name="middlename" placeholder="Middle Name" value="{{ old('middlename') }}" type="text" />
			                        	                </div>
			                        	            </div>
			                        	            <div class="form-group">
			                        	                <label class="col-sm-2 control-label" for="lastname">Last Name
			                        	                    *</label>
			                        	                <div class="col-sm-10">
			                        	                    <input aria-required="true" class="form-control required" id="lastname" name="lastname" placeholder="Last Name" value="{{ old('lastname') }}" type="text" />
			                        	                </div>
			                        	            </div>
			                        	            <div class="form-group">
			                        	                <label class="col-sm-2 control-label" for="email">Email *</label>
			                        	                <div class="col-sm-10">
			                        	                    <input aria-required="true" class="form-control required email" id="email" name="email" placeholder="E-Mail" type="email" value="{{ old('email') }}" />
			                        	                </div>
			                        	            </div>
			                        	            <div class="form-group">
			                        	                <label class="col-sm-2 control-label" for="password">Password *</label>
			                        	                <div class="col-sm-10">
			                        	                    <input aria-required="true" class="form-control required" id="password" name="password" placeholder="Password" type="password" />
			                        	                </div>
			                        	            </div>
			                        	            <div class="form-group">
			                        	        ...
			                        	        <section aria-hidden="true" aria-labelledby="wizard-h-2" class="body" id="wizard-p-2" role="tabpanel" style="display: no ne;">
			                        	            <div class="form-group">
			                        	                ...
			                        	                <div class="col-sm-10">
			                        	                    <select class="form-control" name="gender" title="Select Gender...">
			                        	            ...
			                        	            <div class="form-group">
			                        	                ...
			                        	                <div class="col-sm-10">
			                        	                    <select class="form-control" id="country" name="country"><option selected="selected" value="">Select</option>
			                        	                        ...
			                        	                        <option value="BD" selected="true">Bangladesh</option>
			                        	            ...
			                        	            <div class="form-group">
			                        	                ...
			                        	                <div class="col-sm-10">
			                        	                    <input class="form-control" id="postal" name="postal" type="text" value="{{ old('postal') }}" />
			                        	                </div>
			                        	            </div>
			                        	        </section>
			                        	        <!-- fourth tab -->
			                        	        ...
			                        	        <section aria-hidden="true" aria-labelledby="wizard-h-3" class="body" id="wizard-p-3" role="tabpanel" style="display: non e;">
			                        	            ...
			                        	            <div class="form-group">
			                        	                <label class="col-sm-2 control-label" for="activate">
			                        	                    Activate User</label>
			                        	                <div class="col-sm-10">
			                        	                    <input class="pos-rel p-l-30" id="activate" name="activate" type="checkbox" value="1"> <span>If user is not activated, mail will be sent to user with
