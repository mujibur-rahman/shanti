                        ...
                        <div class="panel-body">
                           <div class="dataTables_wrapper no-footer" id="table_wrapper">
                            ...
                            <div class="table-responsive"> 
                                <table aria-describedby="table_info" role="grid" class="table table-bordered  dataTable no-footer" id="table">
                                <thead>
                                    <tr class="filters" role="row">
                                        <th aria-controls="table" aria-label="ID: activate to sort column ascending" aria-sort="ascending" class="sorting_asc" colspan="1" rowspan="1" style="width: 26px;" tabindex="0">ID</th>
                                        <th aria-controls="table" aria-label="First Name: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 135px;" tabindex="0">First
                                            Name</th>
                                        <th aria-controls="table" aria-label="Last Name: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 153px;" tabindex="0">Last
                                            Name</th>
                                        <th aria-controls="table" aria-label="User E-mail: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 200px;" tabindex="0">User
                                            E-mail</th>
                                        <th aria-controls="table" aria-label="User Roles: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 100px;" tabindex="0">Roles</th>
                                        <th aria-controls="table" aria-label="Status: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 69px;" tabindex="0">Status</th>
                                        <th aria-controls="table" aria-label="Created At: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 96px;" tabindex="0">Created
                                            At</th>
                                        <th aria-controls="table" aria-label="Actions: activate to sort column ascending" class="sorting" colspan="1" rowspan="1" style="width: 50px;" tabindex="0">Actions</th></tr>
                                </thead>
                                <tbody>
                                ...
                                @foreach($users as $key => $value)
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            ...
                                            <a href="{{ url('user', $value->id) }}"><i style="width: 18px; height: 18px;" id="livicon-48" class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view user"></i>View</a>
                                            |
                                            <a href="{{ url('user', [$value->id, 'edit']) }}"><i style="width: 18px; height: 18px;" id="livicon-49" class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="update user"></i>Edit</a>
                                            |
                                            {!! Form::open(array('method' => 'DELETE', 'route' => array('user.destroy', $value->id))) !!}
                                                {!! Form::submit('Delete', array('class' => 'btn btn-danger')) !!}
                                            {!! Form::close() !!}
                                            <!--a href="#" id="user-{{ $value->id}}" onclick="actionDelete('{{ $value->id}}')"><i style="width: 18px; height: 18px;" id="livicon-49" class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="update user"></i>Delete</a-->
...
@section('scripts')
 ...
 <script>
    $(function() {
        ...
        //     var confirm = window.confirm("Dure do you want to delete?");
        // if(confirm){
           
        //    // window.location.href = '{{ url("user/1/delete") }}';
        // }
        // });
