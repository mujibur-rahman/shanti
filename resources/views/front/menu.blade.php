			...
			<div class="col-md-12"><div class="top-menu">
				<nav class="navbar" role="navigation">
					<div class="navbar-inner">
						...
						<li><a href="/" title="">{{ trans('front/menu.home')}}</a></li>
						<li><a href="/category/article/1" title="">
						{{ trans('front/menu.restaurant')}} 
						</a></li>      
						<li><a href="/category/article/3" title="">{{ trans('front/menu.club')}} </a></li>
						<li><a href="/category/article/4" title="">{{ trans('front/menu.science')}} </a></li> 
						<li><a href="/category/article/5" title="">{{ trans('front/menu.shopping')}} </a></li>    
						<li><a href="/category/article/6" title="">{{ trans('front/menu.citylife')}} </a></li>
						<li><a href="http://www.shantidhaka.com/blog/" target="_blank" title="">{{ trans('front/menu.blog')}} </a></li> 
						<li><a href="/category/article/7" title="">{{ trans('front/menu.guide')}} </a></li> 
